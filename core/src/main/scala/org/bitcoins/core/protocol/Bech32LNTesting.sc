...
//BOLT11 Example #1
var lnTags = LNTags("0001020304050607080900010203040506070809000102030405060708090102", Some("Please consider supporting this project"), None, None, None, None, None, None)
...
//BOLT11 Example #2
lnTags = LNTags("0001020304050607080900010203040506070809000102030405060708090102", Some("1 cup coffee"), None, None, Some(60), None, None, None)
...
lnTags = LNTags("0001020304050607080900010203040506070809000102030405060708090102", Some("ナンセンス 1杯"), None, None, Some(60), None, None, None)
LNInvoice(MainNet, Some(2500, CurrencyUnits.oneMBTC), lnTags,
...
//BOLT11 Example #4
lnTags = LNTags("0001020304050607080900010203040506070809000102030405060708090102", None, None, Some("3925b6f67e2c340036ed12093dd44e0368df1b6ea26c53dbe4811f58fd5db8c1"), None, None, None, None)
...
//BOLT11 Example #5
lnTags = LNTags("0001020304050607080900010203040506070809000102030405060708090102", None, None, Some("3925b6f67e2c340036ed12093dd44e0368df1b6ea26c53dbe4811f58fd5db8c1"), None, None, Some("71d7daf61a4972a083f98cee48f05ed9090cdd9e"), None)
LNInvoice(MainNet, Some(20, CurrencyUnits.oneBTC), lnTags,
